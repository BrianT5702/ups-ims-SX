...
<head>
    ...
    <style>
        ...
        * { 
        ...
        .items-table { width: 100%; border-collapse: collapse; margin-bottom: 10px; table-layout: fixed; font-size: 0.92em; /* Increased by 1px */ }
        .items-table th { padding: 6px 8px 4px 8px; /* Reduced padding */ text-align: left; border-bottom: 1px solid #000; border-top: 1px solid #000; font-weight: bold; text-transform: uppercase; font-size: 0.77em; /* Increased by 1px */ line-height: 1.3; /* Reduced line spacing */ }
        .items-table td { padding: 4px 8px; /* Reduced padding */ text-align: left; vertical-align: top; border-bottom: none; font-size: 0.92em; /* Increased by 1px */ line-height: 1.3; /* Reduced line spacing */ }
    ...
    <div class="container">
        ...
        <div class="content">
            <div id="print-source">
                ...
                @if(!empty(trim($quotation->remark ?? '')))
