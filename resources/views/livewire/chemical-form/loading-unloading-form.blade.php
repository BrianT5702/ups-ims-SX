<div class="list-page-unified-density">
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="fw-bold mb-0 list-page-unified-title">Chemical Loading and Unloading</h5>
                    </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="btn-group w-100">
                                        <button type="button" wire:click="$set('selectedChemical', 'Pentane')" class="btn btn-sm {{ $selectedChemical == 'Pentane' ? 'btn-primary' : 'btn-outline-secondary' }}">Pentane</button>
                                        <button type="button" wire:click="$set('selectedChemical', 'PH1139')" class="btn btn-sm {{ $selectedChemical == 'PH1139' ? 'btn-primary' : 'btn-outline-secondary' }}">Polyol (PH1139)</button>
                                        <button type="button" wire:click="$set('selectedChemical', 'KH1250')" class="btn btn-sm {{ $selectedChemical == 'KH1250' ? 'btn-primary' : 'btn-outline-secondary' }}">Isocyanate (KH1250)</button>
                                    </div>
                                </div>
                                        ...
                                        <div class="card bg-light border">
                                            <div class="card-body p-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" wire:model="isFollowDO" id="isFollowDO" style="transform: scale(1.15);">
                                                    <label class="form-check-label fw-semibold follow-do-label" for="isFollowDO">Follow DO</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-hover table-bordered table-bordered-groups chemical-form-table">
                                <thead>
                                    <tr>
                                        <th width="5%">ID</th>
                                        <th width="7%">Tank</th>
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="11" class="text-center">No loading/unloading records found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                            <div class="mt-3 chemical-form-pagination">
    ...
    <style>
        ...
        .list-page-unified-density .input-group-sm .input-group-text {
            font-size: 0.78rem;
        }
        ...
        .table.chemical-form-table {
            --bs-table-border-color: #d0d7e2;
            table-layout: auto;
            width: 100%;
        }
        .table.chemical-form-table > :not(caption) > * > * {
            border-color: var(--bs-table-border-color);
        }
        .table.chemical-form-table thead th {
            font-size: 0.78rem;
            line-height: 1.4;
            vertical-align: middle;
            padding: 0.5rem;
        }
        .table.chemical-form-table thead tr:first-child th:not(.chemical-percentage-header):not(.chemical-percentage-subheader) {
            background-color: #f4f6fa;
        }
        .table.chemical-form-table thead tr:nth-child(2) th:not(.chemical-percentage-subheader) {
            background-color: #f4f6fa;
        }
        .table.chemical-form-table tbody td {
            font-size: 0.8rem;
            line-height: 1.25;
            padding: 0.5rem;
            vertical-align: middle;
