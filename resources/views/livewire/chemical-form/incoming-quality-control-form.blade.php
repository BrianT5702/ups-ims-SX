            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="fw-bold mb-0 list-page-unified-title">Incoming Quality Control</h5>
                    </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <form wire:submit.prevent="addIncomingQC" class="row g-3">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        <button type="submit" class="btn btn-primary btn-sm">Add Quality Control Record</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-hover table-bordered chemical-form-table">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>DO Number</th>
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center">No quality control records found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
