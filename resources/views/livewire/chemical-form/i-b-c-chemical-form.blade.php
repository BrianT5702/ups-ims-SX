            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="fw-bold mb-0 list-page-unified-title">IBC Tank Chemical Stock Level</h5>
                    </div>
                            ...
                            <div class="col-md-12">
                                <form wire:submit.prevent="addChemicalStock" class="row g-3">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        <button type="submit" class="btn btn-primary btn-sm">Add Stock Record</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-hover table-bordered chemical-form-table">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center">No chemical stock records found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
